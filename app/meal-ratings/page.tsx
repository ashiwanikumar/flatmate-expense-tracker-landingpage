      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex justify-between items-center">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Meal Ratings</h1>
        ...
        {stats && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="text-sm text-gray-600 mb-1">Would Eat Again</div>
              <div className="text-2xl font-bold text-gray-900">
                {stats.overall.wouldEatAgainCount}
              </div>
            </div>
            <div className="bg-white p-6 rounded-lg shadow">
              <div className="text-sm text-gray-600 mb-1">Avg Taste Score</div>
              <div className="text-2xl font-bold text-gray-900">
                  ...
                  {rating.wouldEatAgain !== null && rating.wouldEatAgain !== undefined && (
                    <div className="mb-4">
                      {rating.wouldEatAgain ? (
                        <span className="text-sm text-green-600">✓ Would eat again</span>
                      ) : (
                        <span className="text-sm text-red-600">✗ Would not eat again</span>
                      )}
                    </div>
                  )}
